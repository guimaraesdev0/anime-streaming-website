...
$temporada = "SELECT * FROM temporadas";
        ...
        <div class="row">
            ...
            <div class="col-12 postar-admin">
               ...
               <?php
                            ...
                            ?>             
               <form action="postar_ep.php" method="post">

                    Anime: <select name="anime">
                            <?php
                            while ($row_temporada = mysqli_fetch_assoc($temporada2)) {
                                echo ("<option value='" . $row_temporada['id'] . "'>" . $row_temporada['titulo'] . " | temp: " . $row_temporada['temporada'] . "</option>");
                            }
                            ?>
                            </select><br>   
                            N° Episódio<input type="number" name="episodio" placeholder="Ex: 1"><br>
                            Link do episodio<input type="text" name="link" placeholder="Link para embed"><a href="ajuda/embed.html">Ajuda com link's</a><br>
